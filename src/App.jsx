...
const tokenModule = sdk.getTokenModule(
  "0xEB11ad72A9FFE68Bb39cdD4dCdBdf70443eEfc45"
);

const voteModule = sdk.getVoteModule(
  "0x5437777eAc227d35B241b114f6701f3D3B51c316",
);
...
//***HERE IS WHERE IM PUTTING VOTING STUFF */
...
if (hasClaimedNFT) {
  ...
  return (
    <div className="mint-nft">
      <h1>Mint your free ☘️CelticDAO Membership NFT</h1>
      <button
        disabled={isClaiming}
        onClick={() => mintNft()}
      >
